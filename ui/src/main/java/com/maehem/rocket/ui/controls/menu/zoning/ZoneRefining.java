 ...
 * @author maehem
 */
public class ZoneRefining extends DialogPanel {

    private static final Logger LOGGER = Logger.getLogger(ZoneRefining.class.getName());

    private final Game game;

    public ZoneRefining(Game game, DialogLayer dialogLayer, double x, double y) {
        super("Settings", dialogLayer, x, y);
        this.game = game;
