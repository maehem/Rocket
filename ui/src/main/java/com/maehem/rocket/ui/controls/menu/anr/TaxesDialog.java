 ...
 * @author maehem
 */
public class TaxesDialog extends DialogPanel {
    private static final Logger LOGGER = Logger.getLogger(TaxesDialog.class.getName());
    private static final ResourceBundle MSG = ResourceBundle.getBundle("MessageBundle");

public TaxesDialog(Game game, DialogLayer dialogLayer, double x, double y) {
        super(MSG.getString("MENU_ANR_TAXES"), dialogLayer, x, y);
    }
